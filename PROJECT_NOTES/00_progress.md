...
| 17 | Clean mosaic resume (batch_size=3, float32) | 🔄 IN PROGRESS — resuming from ep15 (AP=0.3027); training at ep17+; W&B dfine_s_visdrone_mosaic_resume |
...
- UAV-DETR-R50 (2025): AP50:95=0.315 — best published with standard eval
- RT-DETR-R50 (2023): AP50:95=0.284 — direct predecessor architecture
- Our D-FINE-S at 640px: 0.231 — 73% of SOTA with a 10M param model

Gap is explained by: (1) small model size, (2) 640px input vs 1280-1536px in SOTA papers.
